...
const fr = {
  ...
  editor: {
    ...
    lensFree: 'Libre',
    lensAnchors: 'Ancres',
    // iter-M phase-r.2.6.2/.4 : tooltips du toggle unique Dessin libre↔interpolé
    // (icône Spline). « active » = mode interpolé (spline) en cours.
    lensToggleActiveTitle: 'Mode Dessin interpolé — Cliquer pour activer le mode libre',
    lensToggleInactiveTitle: 'Mode Dessin libre — Cliquer pour activer le mode interpolé',
    anchorCount: 'Ancres',
