# Guide : la Bibliothèque

La Bibliothèque est l'onglet où vivent tes sons. Chaque patch créé
dans le [Designer](doc:guide-designer) y est rangé, prêt à resservir
dans le [Composer](doc:guide-composer). C'est ton bac de rangement —
pas d'édition sonore ici, seulement de l'organisation. Pour un
...
fois » (tu entres et ressors des dossiers) ou l'arborescence
...
(Ctrl+C), couper (Ctrl+X), coller (Ctrl+V) dans le dossier courant.
<DocLink target="library:library-clipboard-chip">Une pastille</DocLink>
indique ce qui est en attente de collage ; Échap la vide. Pour
renommer un item, utilise
...
[Composer](doc:guide-composer) pour les arranger.
