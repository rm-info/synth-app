...
//     ∈ {'vibrato','tremolo','autoPan'(T.2),'pitchEnv'(T.3),'filter'(T.4),'filterEnv'(T.5),'wah'(T.5),'distortion'(T.6),'driveEnv'(T.6bis)}, défaut 'vibrato' ; validé à l'hydratation, hors undo),
